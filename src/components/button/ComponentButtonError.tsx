...
export function ComponentButtonError(props: { text: string; sizeWidth?: string; sizeHeight?: string; loading?: boolean, onClick?: any,id:string }) {
  return (
    <Stack spacing={2} onClick={props.onClick} >
      <Button
        color='error'
        id={`button-error-${props.id}`}
        variant='contained'

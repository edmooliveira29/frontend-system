							...
							<div className='contact-wrap w-100 p-md-5 p-4'>
								...
								<form method='POST' id='contactForm' name='contactForm' className='contactForm'>
									<div className='row'>
										...
										<div className='col-md-12'>
											<div className='form-group'>
												<TextFieldInput label='Asssunto' typeInput='text' />
											</div>
										</div>
										<div className='col-md-12'>
											<div className='form-group'>
										...
										<div className='col-md-12 m-2'>
											<div className='form-group'>
												<ComponentButtonCommon text='Enviar' width='100%'/>
											</div>
										</div>
									</div>
								</form>
					...
					<div className='row'>
						...
						<div className='col-md-4'>
							<div className='dbox w-100 text-center '>
								...
								<div className='text'>
									<p><span>Telefone:</span> <a href=''>(31)99999-9999</a></p>
								</div>
							</div>
						</div>
						<div className='col-md-4'>
							<div className='dbox w-100 text-center '>
								...
								<div className='text'>
									<p><span>Email:</span> <a href='mailto:info@yoursite.com'>website@contato.com</a></p>
								</div>
							</div>
						</div>
					</div>
